...
template<> WWISEPROJECTDATABASE_API UScriptStruct* StaticStruct<FWwiseDatabaseLocalizableNameKey>()
{
	...
	struct Z_CompiledInDeferFile_FID_MainProject_Plugins_Wwise_Source_WwiseProjectDatabase_Public_Wwise_WwiseDatabaseIdentifiers_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MainProject_Plugins_Wwise_Source_WwiseProjectDatabase_Public_Wwise_WwiseDatabaseIdentifiers_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MainProject_Plugins_Wwise_Source_WwiseProjectDatabase_Public_Wwise_WwiseDatabaseIdentifiers_h_1108027461(TEXT("/Script/WwiseProjectDatabase"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MainProject_Plugins_Wwise_Source_WwiseProjectDatabase_Public_Wwise_WwiseDatabaseIdentifiers_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MainProject_Plugins_Wwise_Source_WwiseProjectDatabase_Public_Wwise_WwiseDatabaseIdentifiers_h_Statics::ScriptStructInfo),
		nullptr, 0);
